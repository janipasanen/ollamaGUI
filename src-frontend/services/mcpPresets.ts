...
export const MCP_SERVER_PRESETS: McpServerPreset[] = [
  ...
  },
  {
    ...
    name: 'Kiion',
    icon: '🔷',
    description: 'Kiion remote MCP server.',
    type: 'http',
    url: 'https://mcp.kiion.io/mcp/v1/',
    authRequired: true,
    docsUrl: 'https://mcp.kiion.io/',
  },
  {
    key: 'kiion-crm',
    name: 'KiiOn CRM',
    icon: '📇',
    description: 'KiiOn CRM MCP server (Supabase edge function).',
    type: 'http',
    url: 'https://ebwrpsmvnvudoampvhok.supabase.co/functions/v1/dev-mcp-server',
    authRequired: false,
